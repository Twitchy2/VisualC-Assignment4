...
namespace VisualC_Assignment4.Assignment4DataSetTableAdapters {
...
SELECT productID, cost, manufacturer, model, RAM_type, RAM_size, displaytype, screensize, resolution, CPU_Class, CPU_brand, CPU_type, CPU_speed, CPU_number, condition, OS, platform, HDD_size, HDD_speed, GPU_Type, optical_drive, Audio_type, LAN, WIFI, width, height, depth, weight, moust_type, power, webcam FROM products WHERE (productID = SCOPE_IDENTITY())";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::VisualC_Assignment4.Properties.Settings.Default.Assignment4ConnectionString;
        }
        ...
        public virtual int Fill(Assignment4DataSet.productsDataTable dataTable) {
        ...
        public virtual Assignment4DataSet.productsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Assignment4DataSet.productsDataTable dataTable = new Assignment4DataSet.productsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Assignment4DataSet.productsDataTable dataTable) {
